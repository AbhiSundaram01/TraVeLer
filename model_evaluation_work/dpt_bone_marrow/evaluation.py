...
GNN learns to approximate top-10 PCA embeddings; DPT is run on soft PCA
embeddings (P @ X_pca) and compared (Spearman r) against control DPT.
...
def setup_run(label: str = "dpt_bone_marrow"):
...
def main():
    _, run_dir, logger = setup_run("dpt_bone_marrow")

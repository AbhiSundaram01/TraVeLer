...
def test_diffeo_net():
    ...
    # Visualize the transformation in 2D for easier visualization
    if dim >= 2:
        dim_2d = 2
...
def test_jacobian_computation():
    """Test the Jacobian computation in PullbackOneForm"""
    ...
    # Compute Jacobian using functional.jacobian (cleaner approach)
    try:

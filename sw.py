...
epochs = 100
losses, node_embeddings, correlations = train_model(model, vf, optimizer, x, adj, adata, epochs, run_dir, logger)
...
# Title
plt.title('GNN Training: Loss and Pseudotime Correlation (neighbours = 50)')
